                      ...
                      <div class="card-body p-4 p-md-5">
                          ...
                          <form name="form" action="create_account.jsp" onsubmit="return validateform(this)">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6 mb-4">
                                      <div class="form-outline">
                                          <input type="text" class="form-control form-control-lg"  id="contact" name="contact" required autocomplete="off" />
                              ...
                              <div class="row">
                                  <div class="col-md-12 mb-4">
                                      <div class="form-outline">
                                          ...
                                          <textarea class="form-label address-textarea"  id="address" name="address" required autocomplete="off" maxlength="200"></textarea>
                                      </div>
                                  </div>
